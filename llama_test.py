...
# llm = LLM()
# message = "There was an earthquake in Asia this month."
# print(llm.check_if_news_is_fake(message))
# print(llm.check_if_news_is_fake(message, fact="There was no earthquake in Asia this month."))
# print(llm.spread_the_news(message))